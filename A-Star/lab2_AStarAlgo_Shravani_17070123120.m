...
% Theory: A* is a graph traversal and path search algorithm, which is often
% used in many fields of computer science due to its completeness, 
% optimality, and optimal efficiency. One major practical drawback is its 
...
%% Conclusion:
% Hence through this algorithm we genenate shortest path by setting a
% target, a source and creating obstacles.