...
%% Conclusion:
% When iterations were 500 the model's best cost becomes stagnant and
% therefore goes into the case of overfitting. When the iterations are
% reduced to 100 the best cost is still varying and therefore provides with
% a faster convergence, lower time taken and an optimised path and therefore 
% avoids pre mature convergence.
