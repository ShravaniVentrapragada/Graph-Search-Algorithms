...
% PRN:17070123120
% Batch: G-5 (E&TC)
%% This program is developed to find shortest path (minimum cost)between some cities. 
% 
...
% metaheuristics and an intelligent optimization algorithms, inspired by
% social behavior of ants. ACO algorithms are also categorized as Swarm 
% Intelligence methods, because of implementation of this paradigm, via 
...
%% Conclusion:
% This code implementation of Ant Colony Optimization (ACO) to solve 
% traveling ‎salesman problem (TSP). Given a list of cities and their 
% pairwise distances, the task is to find a shortest ‎possible tour that 
% visits each city exactly once. ‎And hence through the output graphs
% plotted we can observe the desired output.
